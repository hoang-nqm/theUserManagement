 ...
 * @author Minh Hoang
 */
@WebServlet(name = "GetUserByRoleController", urlPatterns = {"/GetUserByRoleController"})
public class GetUserByRoleController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!roleID.isEmpty()) {
                List<UserDTO> listUser = userDAO.searchByRoleID(roleID);
